...
export const Header = () => {
  ...
  return (
    <>
        ...
        <div className="px-4 max-w-7xl mx-auto">
          <div className="flex h-14 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {/* Logo — visible on mobile, hidden on desktop where sidebar has it */}
              <NavLink
                to="/"
      ...
      {/* Drawer — rendered here but controlled by AppLayout passing props isn't needed;
          we keep it simple and let AppLayout handle the drawer */}
    </>
  );
};
