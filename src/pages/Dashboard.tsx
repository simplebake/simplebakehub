            ...
            <>
              {isContentVisible('premixes') && (
                <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/premixes")}>
                  <CardHeader>
                    ...
                    <CardDescription>Step-by-step instructions for each premix</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button variant="ghost" className="w-full">Start Baking →</Button>
                  </CardContent>
                </Card>
              )}
              ...
              {isContentVisible('tutorials') && (
                <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/tutorials")}>
                  <CardHeader>
                    ...
                    <CardDescription>Learn tips, techniques, and best practices</CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              {isContentVisible('community_bakes') && (
                <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/share")}>
                  <CardHeader>
                    ...
                    <CardDescription>Show off your creations to the community</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button variant="ghost" className="w-full">Share Now →</Button>
                  </CardContent>
                </Card>
              )}
              ...
              <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/bake-analysis")}>
                <CardHeader>
                  ...
                  <CardDescription>Upload a photo and get AI feedback on your bake</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button variant="ghost" className="w-full">Analyse Now →</Button>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/recipe-generator")}>
                <CardHeader>
                  ...
                  <CardDescription>Create custom gluten-free recipes from your ingredients</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button variant="ghost" className="w-full">Create Recipe →</Button>
                </CardContent>
              </Card>
            </>
          )}
